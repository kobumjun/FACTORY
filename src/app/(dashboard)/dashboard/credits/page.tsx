...
export default async function CreditsPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        <h2 className="mb-4 text-lg font-medium text-white">크레딧 사용량</h2>
      ...
      <div className="border border-dashed border-zinc-700 bg-zinc-900 p-6 text-center text-zinc-500">
